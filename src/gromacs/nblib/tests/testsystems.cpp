...
MethanolMoleculeBuilder::MethanolMoleculeBuilder() : methanol_("MeOH")
{
    ...
    //! Add the particles
    methanol_.addParticle(ParticleName("Me1"), Charges.at("CMet"), plib.type("CMet"));
    methanol_.addParticle(ParticleName("O2"), Charges.at("OMet"), plib.type("OMet"));
    methanol_.addParticle(ParticleName("H3"), Charges.at("HMet"), plib.type("H"));
...
Topology WaterTopology::buildTopology(int numMolecules)
{
    ...
    {
        interactions.add(library.type(name), library.c6(name), library.c12(name));
    }
...
ArgonTopologyBuilder::ArgonTopologyBuilder(const int& numParticles)
{
    ...
    nbinteractions.add(library.type("Ar"), library.c6("Ar"), library.c12("Ar"));
