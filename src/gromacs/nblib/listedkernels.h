 ...
 */
#ifndef GMX_NBLIB_LISTEDKERNELS_H
#define GMX_NBLIB_LISTEDKERNELS_H
...
extern template std::tuple<real, real> harmonicScalarForce(real k, real x0, real x);
extern template std::tuple<real, real, real> harmonicScalarForce(real kA, real kB, real xA, real xB, real x, real lambda);
